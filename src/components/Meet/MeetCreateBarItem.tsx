import React, {FC, useState, MouseEvent, useRef, useCallback, useEffect} from 'react';
import {Box, Button, Card, CardActions, CardContent, InputAdornment, IconButton, TextField, Typography, Zoom, Snackbar, Alert, Badge} from "@mui/material";
...
const MeetCreateBarItem: FC<IMeetCreateBarItem> = ({type, onClickCreate, onClickJoin}) => {
    ...
    const onCardClickHandler = (e?: MouseEvent<HTMLDivElement>) => {
